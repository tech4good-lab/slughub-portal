    ...
    for (const club of clubsNeedingReminders) {
      ...
      try {
        const ok = await sendMail({
          ...
          text: `Hello ${club.name}. As it's been over a year since your last update, please take a moment to update your club information on the SlugHub directory. Thank you!`,
        });
        if (ok) {
