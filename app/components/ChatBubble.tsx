...
const CHAT_MESSAGES = [
  ...
  "Not sure which clubs match your schedule? Ask SlugPath for advice",
...
export default function ChatBubble() {
  ...
  return (
    <aside className={styles.container} aria-label="SlugPath Chat Assistant">
      ...
      {/* Main Square Bubble Container */}
      <div className={`${styles.squareWrapper} ${styles.interactive}`}>
        <a
          href={CHAT_URL}
          target="_blank"
          rel="noopener noreferrer"
